...
```js [Section1Component.jsx]
    ...
    useEffect(()=>{
        ...
        //     idx % 2 === 1 ? console.log( "2행, 4행" + idx ) : console.log( "1행, 3행, 5행" + idx ) // 0 1 2 3 4
        // );
...
```JS [HeaderComponent.jsx]
    ...
    useEffect(()=>{
        ...
        */
        ...
        // 객체를 지정하는 방식
        // . 점표기법 => 공백이 포함안된상태만 가능
        // [''] 대괄호 점표기법 => 공백이 포함된 상태도 가능
        console.log( state.메인메뉴.OnSale ); // . 점표기법
        console.log( state.메인메뉴['OnSale'] ); // 자식요소 배열 모두
        console.log( state.메인메뉴.기획전 ); // . 점표기법
        console.log( state.메인메뉴['기획전'] ); // 자식요소 배열 모두
        console.log( state.메인메뉴['푸른마을 레시피'] ); // 자식요소 배열 모두 // [''] 공백포함 대괄호 점표기법
        console.log( state.메인메뉴.매장안내 ); // . 점표기법
